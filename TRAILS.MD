...
| 3        | Canyon Crest Trail    | Sedona         | AZ    | 4.7      | Challenging climb with panoramic canyon vistas and red rock formations. | Hard        |
| 4        | Bear Hollow Trail     | Bozeman        | MT    | 5.2      | Winding trail through forested valleys with wildlife sightings. | Moderate    |
| 5        | Cedar River Loop      | Seattle        | WA    | 3.0      | Flat riverside path great for birdwatching and peaceful walks. | Easy        |
| 6        | Sunset Vista Trail    | Phoenix        | AZ    | 2.8      | Desert trail with stunning sunset views over rocky terrain.  | Moderate    |
| 7        | Eagle Rock Path       | Los Angeles    | CA    | 1.9      | Short hike with sweeping views of the city and iconic rock formations. | Easy        |
| 8        | Mountain View Trail   | Denver         | CO    | 6.0      | High-altitude trail with rugged terrain and mountain panoramas. | Hard        |
| 9        | Fern Gully Loop       | Portland       | OR    | 2.2      | Lush fern-lined trail with plenty of shade and a small creek. | Easy        |
| 10       | Ridge Line Trail      | Salt Lake City | UT    | 4.0      | Trail along a ridge with excellent valley views and wildflowers. | Moderate    |
...
| 13       | Red Canyon Loop       | St. George     | UT    | 4.4      | Loop trail through striking red rock formations and steep inclines. | Hard        |
...
| 44       | Buffalo Trace Trail   | Frankfort      | KY    | 5.0      | Historic trail once used by buffalo herds, now a forested path. | Hard        |
